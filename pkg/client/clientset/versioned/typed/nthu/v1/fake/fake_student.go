...
import (
	student_v1 "practice-operator/pkg/apis/student/v1"
...
func (c *FakeStudents) Get(name string, options v1.GetOptions) (result *student_v1.Student, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(studentsResource, c.ns, name), &student_v1.Student{})

	if obj == nil {
		return nil, err
	}
	return obj.(*student_v1.Student), err
}

// List takes label and field selectors, and returns the list of Students that match those selectors.
func (c *FakeStudents) List(opts v1.ListOptions) (result *student_v1.StudentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(studentsResource, studentsKind, c.ns, opts), &student_v1.StudentList{})
	...
	list := &student_v1.StudentList{}
	for _, item := range obj.(*student_v1.StudentList).Items {
...
func (c *FakeStudents) Create(student *student_v1.Student) (result *student_v1.Student, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(studentsResource, c.ns, student), &student_v1.Student{})
...
func (c *FakeStudents) Update(student *student_v1.Student) (result *student_v1.Student, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(studentsResource, c.ns, student), &student_v1.Student{})
...
func (c *FakeStudents) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(studentsResource, c.ns, name), &student_v1.Student{})
...
func (c *FakeStudents) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &student_v1.StudentList{})
	return err
}

// Patch applies the patch and returns the patched student.
func (c *FakeStudents) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *student_v1.Student, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(studentsResource, c.ns, name, data, subresources...), &student_v1.Student{})
